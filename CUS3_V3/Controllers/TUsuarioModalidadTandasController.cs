...
namespace CUS3_V3.Controllers
{
    public class TUsuarioModalidadTandasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PkVumtCod,FkIumtCodPart,FkIumtCodTan,IumtPuntajeTotal,IumtPista")] TUsuarioModalidadTanda tUsuarioModalidadTanda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("PkVumtCod,FkIumtCodPart,FkIumtCodTan,IumtPuntajeTotal,IumtPista")] TUsuarioModalidadTanda tUsuarioModalidadTanda)
        {
